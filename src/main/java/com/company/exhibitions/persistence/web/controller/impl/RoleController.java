...
import com.company.exhibitions.web.command.enums.RoleCommands;
import com.company.exhibitions.web.command.Command;
import com.company.exhibitions.web.command.rolecommand.*;
...
public class RoleController extends Controller {
    ...
    public Command defineCommand(String command) {
        switch (RoleCommands.valueOf(command.toUpperCase())){
            case INSERT_ROLE:
