...
import com.company.exhibitions.web.command.enums.UserCommands;
import com.company.exhibitions.web.command.Command;
import com.company.exhibitions.web.command.usercommand.*;
...
public class UserController extends Controller {
    ...
    public Command defineCommand(String command) {
        switch(UserCommands.valueOf(command.toUpperCase())){
            case INSERT_USER:
