...
import com.company.exhibitions.web.command.enums.ShowroomCommands;
import com.company.exhibitions.web.command.Command;
import com.company.exhibitions.web.command.showroomcommand.*;
...
public class ShowroomController extends Controller {
    ...
    public Command defineCommand(String command) {
        switch (ShowroomCommands.valueOf(command.toUpperCase())){
