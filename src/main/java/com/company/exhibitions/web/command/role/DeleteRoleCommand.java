...
public class DeleteRoleCommand extends Command {
    ...
    public DeleteRoleCommand(){
        this.controllerValidator = new RoleIdTypeValidator(new RoleIdLengthValidator(null));
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (Objects.nonNull(attribute)) {
            ...
            if(Objects.nonNull(request.getAttribute(CustomRequestAttributes.ROLE.name().toLowerCase()))){
                super.getControllerExecutor().perform(() -> roleService.deleteRole(parameters));
            }
            return pageAdmin;
        }
    }
