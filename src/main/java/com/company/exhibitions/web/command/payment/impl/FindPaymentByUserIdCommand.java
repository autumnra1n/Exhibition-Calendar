...
public class FindPaymentByUserIdCommand extends PaymentCommand {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (!Objects.isNull(attribute)) {
            ...
            return controllerExecutor.performAttributeSelect(() ->{
                List<Payment> payment = paymentService.findPaymentByUserId(extractParameters(request));
                return checkPaymentListPresence(request, payment);
            });
        }
    }
}
